        ...
        <Tabs defaultValue="login">
          ...
          <TabsContent value="login">
            <CardHeader>
              ...
              <CardDescription>
                Log in to access your account and manage your auctions.
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <a 
                        ...
                        className="text-xs text-auction-primary hover:underline"
                      >
                        Forgot password?
                      </a>
                    </div>
          ...
          <TabsContent value="signup">
            <CardHeader>
              ...
              <CardDescription>
                Join our community to buy and sell car parts.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSignup}>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="signup-name" type="text" placeholder="John Smith" required />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="terms" className="text-sm">
                      I agree to the <a href="#" className="text-auction-primary hover:underline">Terms of Service</a> and <a href="#" className="text-auction-primary hover:underline">Privacy Policy</a>.
                    </Label>
                  </div>
            ...
            <CardFooter className="justify-center text-center">
              <p className="text-sm text-gray-600">
                By signing up, you'll also receive occasional auction alerts and newsletters. You can unsubscribe at any time.
              </p>
            </CardFooter>
          </TabsContent>
        </Tabs>
